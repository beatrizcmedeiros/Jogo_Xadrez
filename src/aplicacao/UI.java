...
public class UI {
	...
	public static PosicaoXadrez lePosicaoXadrez(Scanner sc) {
		try {
			...
			throw new InputMismatchException("\nErro ao ler a posicao do xadrez. Os valores validos devem estar entre a1 ate h8.");
		}
	}
	...
	private static void printPeca(PecaXadrez peca, boolean plano_fundo) {
		if(plano_fundo)
